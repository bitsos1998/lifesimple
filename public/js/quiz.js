...
const productInfo = {
  ...
  cohabitsimple:          { name: 'Cohabit<span>Simple</span>', desc: 'Οδηγός σύμφωνου συμβίωσης, βήμα προς βήμα.', price: '€15', live: false, slug: 'cohabitsimple' },
  ...
  custodysimple:          { name: 'Custody<span>Simple</span>', desc: 'Επιμέλεια τέκνων: δικαιώματα, διαδικασία, συμφωνία γονέων.', price: '€19', live: false, slug: 'custodysimple' },
  alimonysimple:          { name: 'Alimony<span>Simple</span>', desc: 'Διατροφή συζύγου & τέκνων: υπολογισμός, δικαιώματα, διαδικασία.', price: '€15', live: false, slug: 'alimonysimple' },
  ...
  funeralsimple:          { name: 'Funeral<span>Simple</span>', desc: 'Τι πρέπει να κάνεις τις πρώτες 48 ώρες μετά από θάνατο.', price: '€15', live: false, slug: 'funeralsimple' },
  donationsimple:         { name: 'Donation<span>Simple</span>', desc: 'Γονική παροχή & δωρεά ακινήτου: διαδικασία και φορολογία.', price: '€19', live: false, slug: 'donationsimple' },
  taxsimple:              { name: 'Tax<span>Simple</span>', desc: 'Φορολογική δήλωση βήμα-βήμα για αρχάριους.', price: '€12', live: false, slug: 'taxsimple' },
  propertytaxsimple:      { name: 'PropertyTax<span>Simple</span>', desc: 'ΕΝΦΙΑ, φόρος μεταβίβασης και τι πρέπει να πληρώσεις.', price: '€15', live: false, slug: 'propertytaxsimple' },
  pensionsimple:          { name: 'Pension<span>Simple</span>', desc: 'Αίτηση σύνταξης ΕΦΚΑ: έγγραφα, προϋποθέσεις, υπολογισμός.', price: '€15', live: false, slug: 'pensionsimple' },
  debtsimple:             { name: 'Debt<span>Simple</span>', desc: 'Ρύθμιση χρεών & εξωδικαστικός μηχανισμός — τα δικαιώματά σου.', price: '€12', live: false, slug: 'debtsimple' },
  powerofattorneysimple:  { name: 'PowerOfAttorney<span>Simple</span>', desc: 'Πληρεξούσιο: τύποι, κόστος, πώς το βγάζεις.', price: '€15', live: false, slug: 'powerofattorneysimple' },
  contractsimple:         { name: 'Contract<span>Simple</span>', desc: 'Ιδιωτικό συμφωνητικό: πρότυπο και οδηγός σύνταξης.', price: '€19', live: false, slug: 'contractsimple' },
  complaintsimple:        { name: 'Complaint<span>Simple</span>', desc: 'Πώς κάνεις καταγγελία σε ΣΕΠΕ, καταναλωτή, ΑΠΔΠΧ.', price: '€12', live: false, slug: 'complaintsimple' },
  tenantsimple:           { name: 'Tenant<span>Simple</span>', desc: 'Δικαιώματα ενοικιαστή & ιδιοκτήτη — τι ισχύει.', price: '€15', live: false, slug: 'tenantsimple' },
  freelancesimple:        { name: 'Freelance<span>Simple</span>', desc: 'Άνοιγμα ατομικής: ΕΦΚΑ, ΔΟΥ, υποχρεώσεις.', price: '€19', live: false, slug: 'freelancesimple' },
  ikesimple:              { name: 'IKE<span>Simple</span>', desc: 'Σύσταση ΙΚΕ μέσω One Stop Shop, βήμα-βήμα.', price: '€25', live: false, slug: 'ikesimple' },
  closesimple:            { name: 'Close<span>Simple</span>', desc: 'Κλείσιμο επιχείρησης: λύση, εκκαθάριση, φορολογική ενημερότητα.', price: '€19', live: false, slug: 'closesimple' },
  invoicesimple:          { name: 'Invoice<span>Simple</span>', desc: 'Τιμολόγηση, myDATA, αποδείξεις — τα βασικά.', price: '€9', live: false, slug: 'invoicesimple' },
};
